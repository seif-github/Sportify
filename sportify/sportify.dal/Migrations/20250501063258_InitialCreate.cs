        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoundedYear = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StadiumName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "TeamTournamentMatchStatistics",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamTournamentMatchStatistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamTournamentMatchStatistics_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeamTournamentMatchStatistics_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeamTournamentMatchStatistics_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamTournamentMatchStatistics_MatchId",
                table: "TeamTournamentMatchStatistics",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamTournamentMatchStatistics_TeamId",
                table: "TeamTournamentMatchStatistics",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamTournamentMatchStatistics_TournamentId",
                table: "TeamTournamentMatchStatistics",
                column: "TournamentId");
